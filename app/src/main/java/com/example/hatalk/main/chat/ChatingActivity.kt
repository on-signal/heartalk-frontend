...
class ChatingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<ImageView>(R.id.send).setOnClickListener(TODO())
        findViewById<ImageView>(R.id.leave).setOnClickListener(TODO())
...
//        }
        ...
        val recyclerView: RecyclerView = findViewById(R.id.chat_recycler)

        //Set Chatroom RecyclerView adapter
        chatingAdapter = ChatingAdapter(this, chatList);
        recyclerView.adapter = chatingAdapter;
...
//    }
    ...
    private fun addItemToRecyclerView(message: Message) {
        ...
        runOnUiThread {
            ...
            editText.setText("")
            findViewById<RecyclerView>(R.id.chat_recycler).scrollToPosition(chatList.size - 1) //move focus on last message
        }
    }
